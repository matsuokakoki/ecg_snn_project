> **HISTORICAL / UNVERIFIED (2026-09-23):** この初期レポートの実験・性能・省電力の記述は、保存済みログとcheckpointで照合できていません。現在の確定結果として引用せず、[results/README.md](README.md) とルートREADMEを先に読んでください。元の記述は履歴として残します。
